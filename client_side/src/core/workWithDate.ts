...
export function get_today_range(date: Date) {
  ...
  return {
    date_start: new Date(Date.UTC(today.getFullYear(), today.getMonth(), today.getDate())),
...
export function get_yesterday_range(date: Date) {
  ...
  return {
    date_start: new Date(Date.UTC(yesterday.getFullYear(), yesterday.getMonth(), yesterday.getDate())),
...
export function get_current_week(date: Date) {
  const startDay = 1
  return {
    date_start: new Date(Date.UTC(date.getFullYear(), date.getMonth(), date.getDate() - date.getDay() + startDay)),
