...
const ControlTablePanel: React.FC<IControlTablePanel> = ({pageSize, setPageSize, options, selectedRows}) => {
  ...
  return <div className="mt-6 mb-4 flex">
    {dateRange}
    {options.template && <TemplateTable templateType={options.template}/>}
    {button_add}
    {button_delete}
    <Selector
      type="secondary"
